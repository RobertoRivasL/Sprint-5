...
public class Capacitacion {
    ...
    public Capacitacion(String identificador, String rutCliente, String dia, String hora, String lugar, String duracion, String cantidadAsistentes, Date created_at) {
