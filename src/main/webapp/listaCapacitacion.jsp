...
<table class="table table-dark">
  ...
  <tr>
    ...
    <td><%= capacitacion.getCreated_at()%></td>
    <td>
      <form method="post" action="svEliminarCap">
        <input type="hidden" name="identificador" value="<%= capacitacion.getIdentificador()%>">
        <button class="btn btn-sm btn-danger" type="button" onclick="confirmarEliminacion('<%= capacitacion.getIdentificador()%>')">Eliminar</button>
      </form>
    </td>
  </tr>
  </tbody>
