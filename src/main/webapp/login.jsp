        ...
        <div class="col-lg-4 col-md-6 col-sm-8">
            <form class="login-form" action="svLogin" method="POST" >
                ...
                <div class="form-group">
                    ...
                    <input name="rutUsuario" type="text" id="Usuario" class="form-control" placeholder="Ingresa Usuario" required>
                </div>
                <br>
                <div class="form-group">
                    <label class="mb-3" for="passwordx">Contraseña</label>
                    <input name="password" type="password" id="passwordx" class="form-control" placeholder="Ingresa tu contraseña" required>
                </div>
                <br>
